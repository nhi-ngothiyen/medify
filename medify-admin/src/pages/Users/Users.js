...
export default function Users() {
    ...
    return (_jsx(Layout, { children: _jsxs("div", { className: "users-container", children: [_jsx("div", { className: "users-header", children: _jsx("h2", { children: "Users Management" }) }), _jsxs("table", { className: "users-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "ID" }), _jsx("th", { children: "Email" }), _jsx("th", { children: "T\u00EAn" }), _jsx("th", { children: "Vai tr\u00F2" }), _jsx("th", { children: "Tr\u1EA1ng th\u00E1i" }), _jsx("th", { children: "H\u00E0nh \u0111\u1ED9ng" })] }) }), _jsx("tbody", { children: items.map((u) => (_jsxs("tr", { children: [_jsx("td", { children: u.id }), _jsx("td", { children: u.email }), _jsx("td", { children: u.full_name }), _jsx("td", { children: u.role }), _jsx("td", { children: _jsx("span", { className: `status-badge ${u.is_active ? 'active' : 'inactive'}`, children: u.is_active ? 'Hoạt động' : 'Không hoạt động' }) }), _jsxs("td", { children: [_jsx("button", { onClick: () => toggle(u.id), className: "action-button", children: u.is_active ? 'Vô hiệu hóa' : 'Kích hoạt' }), _jsx("button", { onClick: () => reset(u.id), className: "action-button reset-button", children: "\u0110\u1EB7t l\u1EA1i MK" })] })] }, u.id))) })] })] }) }));
}
